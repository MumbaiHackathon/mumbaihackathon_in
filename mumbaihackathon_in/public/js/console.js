...
const t = new EmuTerm(document.getElementById('terminal'), {
	...
	handleCommand(command) {
		...
		if (command === 'about') {
			return [
				'--------- Mumbai Hackathon 2022 (⌐■_■) ---------',
				`${t.chalk('9th and 10th April', 'yellow')}`,
				`${t.chalk('Don Bosco Institute of Technology, Kurla', 'yellow')}`,
				`${t.chalk('₹ 1,00,000 Cash Prize', 'yellow')}`,
		...
		if (command === 'register') {
			...
			let team_details = {
				...
				'Team Member 3 (Email) (Optional)': 'email_3',
				'Team Member 4 (Name) (Optional)': 'fullname_4',
				'Team Member 4 (Email) (Optional)': 'email_4',
...
function clear_console() {
	t.clear_console();
	t.write_console([
		"| |&nbsp; _   &nbsp;|&nbsp;  _&nbsp; _&nbsp; __&nbsp;&nbsp;  _  &nbsp;&nbsp;_|_ _ &nbsp;&nbsp;|V| &nbsp;&nbsp;&nbsp;         __  &nbsp;|_&nbsp;  _ &nbsp;o &nbsp;&nbsp;|_| _ &nbsp;_&nbsp;|&nbsp;&nbsp;&nbsp;_  _|_&nbsp;|_&nbsp;  _&nbsp; __ ",
